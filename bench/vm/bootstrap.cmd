...
if exist "%OOMVM_VM%\host.txt" set /p OOMVM_OLLAMA=<"%OOMVM_VM%\host.txt"
if "%OOMVM_OLLAMA%"=="" set "OOMVM_OLLAMA=localhost:11434"
call :say "[bootstrap] ollama ucu = http://%OOMVM_OLLAMA%/v1"
...
:oomjson_tek
if not defined OOMVM_VM set "OOMVM_VM=C:\oom-vm"
if not defined OOMVM_OLLAMA if exist "%OOMVM_VM%\host.txt" set /p OOMVM_OLLAMA=<"%OOMVM_VM%\host.txt"
